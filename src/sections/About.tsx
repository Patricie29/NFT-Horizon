...
const About: FC<AboutProps> = ({ }) => {
    return <section className={`${styles.paddings} relative z-10`}>
        ...
        >
            ...
            >
                {/* MAP IMAGE */}
                <img src="/map.png" alt="map" className='w-full h-[120%] object-cover border scale-[1.3] opacity-20 rounded-[200px]' />

                <motion.p
                    variants={fadeIn('up', 'tween', 0.2, 1)}
                    className='absolute xl:mt-[50px] font-normal text-[14px] sm:text-[16px] md:text-[17px] lg:text-[19px] text-center text-secondary-white py-8 md:px-8 lg:px-16'
                >
