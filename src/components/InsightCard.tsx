...
const InsightCard: FC<InsightCardProps> = ({ index, title, imgUrl, subtitle }) => {
    return <>
        <motion.div
            variants={fadeIn('up', 'spring', index * 0.5, 1)}
            className='flex md:flex-row flex-col gap-4'>

            <img src={imgUrl} alt='planet' className='md:w-[190px] w-full h-[170px] rounded-[32px] object-cover' />
            ...
            <div className='w-full flex justify-between items-center'>
                ...
                <div className='lg:flex hidden items-center justify-center w-[70px] h-[70px] rounded-full bg-transparent border-[1px] border-white'>
                    <img src="/arrow.svg" alt="" className='w-[30%] h-[30%] object-contain' />
                </div>
            </div>
